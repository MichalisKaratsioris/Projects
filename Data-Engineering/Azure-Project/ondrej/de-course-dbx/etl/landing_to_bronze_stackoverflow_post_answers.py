...
# df = spark.read \
# .option("header", True) \
# .csv("/mnt/decoursesa/landing/stackoverflow/stackoverflow_post_answers.csv")
...
answers_schema = StructType(fields=[
...
.mode("overwrite") \
.format("delta") \
.saveAsTable("bronze_db.b_stackoverflow_post_answers")

# COMMAND ----------

# %sql
# DESCRIBE EXTENDED bronze_db.b_stackoverflow_post_answers;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM bronze_db.b_stackoverflow_post_answers
# MAGIC LIMIT 10;
